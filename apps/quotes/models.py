    ...
    def validate(self,post_data):
        ...
        for field,value in post_data.iteritems():
            ...
            if field == "description":
                ...
                if len(self.filter(author=post_data['author']))> 1:
...
class Quote(models.Model):
    ...
    user_upload = models.ForeignKey(User,related_name='user_quote',null = True)
    favorite = models.ManyToManyField(User,related_name='user_favorite', null = True) 
